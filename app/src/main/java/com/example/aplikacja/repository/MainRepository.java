...
import com.example.aplikacja.remote.FirebaseClient;
import com.example.aplikacja.ui.CallActivity;
import com.example.aplikacja.utils.DataModel;
import com.example.aplikacja.utils.DataModelType;
import com.example.aplikacja.utils.ErrorCallBack;
import com.example.aplikacja.utils.NewEventCallBack;
import com.example.aplikacja.utils.SuccessCallBack;
import com.example.aplikacja.webrtc.MyPeerConnectionObserver;
import com.example.aplikacja.webrtc.WebRTCClient;
import com.example.aplikacja.remote.FirebaseClient;
import com.example.aplikacja.webrtc.WebRTCClient;
...
public class MainRepository implements WebRTCClient.Listener {
    ...
    public void sendCallRequest(String target,double longitude, double latitude, ErrorCallBack errorCallBack){
